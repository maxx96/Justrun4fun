...
<body>
    ...
    <div class="section-hero">
        <div class="content hero w-container">
            ...
            <div class="hero-image-block"><img src="{{ asset('images/finish-line.svg') }}"
                    loading="lazy" sizes="(max-width: 991px) 100vw, (max-width: 1439px) 38vw, 484.234375px"
                    srcset="images/finish-line.svg 500w, images/finish-line.svg 535w"
        ...
        <div class="content w-container">
            ...
            <div class="w-layout-grid grid-target">
                <div id="w-node-b922e9023a6a-35de40d0" class="grid-one-target">
                    <div class="target-block-image"><img src="images/realizuj-cele.svg" loading="lazy" alt=""
                ...
                <div id="w-node-8997504ef119-35de40d0" class="grid-one-target">
                    <div class="target-block-image"><img src="images/pomagaj-organizatorom.svg" loading="lazy" alt=""
                            class="target-image"></div>
                    <div class="target-block-text">
                ...
                <div id="w-node-e0fc3773da55-35de40d0" class="grid-one-target">
                    <div class="target-block-image"><img src="images/wspieraj-fundacje.svg" loading="lazy" alt=""
                            class="target-image"></div>
                    <div class="target-block-text">
                ...
                <div id="w-node-1f27fb092fb3-35de40d0" class="grid-one-target">
                    <div class="target-block-image"><img src="images/rywalizuj-z-innymi.svg" loading="lazy" alt=""
                            class="target-image"></div>
                    <div class="target-block-text">
                ...
                <div id="w-node-7701654863b3-35de40d0" class="grid-one-target">
                    <div class="target-block-image"><img src="images/wykonuj-wyzwania.svg" loading="lazy" alt=""
                            class="target-image"></div>
                    <div class="target-block-text">
                ...
                <div id="w-node-9d186e5a32ef-35de40d0" class="grid-one-target">
                    <div class="target-block-image"><img src="images/cwicz-cwicz.svg" loading="lazy" alt=""
                            class="target-image"></div>
                    <div class="target-block-text">
        ...
        <div class="content w-container">
            ...
            <div class="w-layout-grid grid-foundation">
                <div id="w-node-e617a850cf5a-35de40d0" data-w-id="ca9809f8-de1a-068e-6ed6-e617a850cf5a"
                    class="foundation-div"><img src="images/rnr-logo.png" loading="lazy" alt=""></div>
                <div id="w-node-af7de7e64096-35de40d0" class="foundation-div"><img src="images/dds-logo.png"
                        loading="lazy" alt=""></div>
                <div id="w-node-9943a015031b-35de40d0" class="foundation-div"><img src="images/dom-logo.png"
                        loading="lazy" alt=""></div>
                <div id="w-node-95b87edfc4cd-35de40d0" class="foundation-div"><img src="images/pah-logo.png" loading="lazy"
                        alt=""></div>
            </div>
    ...
    <div>
        <div class="content w-container">
            ...
            <div class="w-layout-grid grid-partners">
                <div id="w-node-d210b884e163-35de40d0" class="partner-div"><img src="images/maraton-warszawski-logo.png"
                        loading="lazy" alt=""></div>
                <div id="w-node-75dc3d9c4a73-35de40d0" class="partner-div"><img src="images/wroclaw-maraton-logo.png"
                        loading="lazy" alt=""></div>
                <div id="w-node-0ab33c18c99d-35de40d0" class="partner-div"><img src="images/poznan-maraton-logo.png" loading="lazy"
                        alt=""></div>
                <div id="w-node-6bf61f54ff91-35de40d0" class="partner-div"><img src="images/maraton-debno-logo.png" loading="lazy"
                        alt=""></div>
                <div id="w-node-74a6e87a23bb-35de40d0" class="partner-div"><img src="images/gdynia-polmaraton-logo.png" loading="lazy"
                        alt=""></div>
            </div>
        </div>
    </div>
