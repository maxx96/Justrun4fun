...
<body>
  ...
  <div class="section-hero">
    <div class="content hero w-container">
      ...
      <div class="hero-image-block"><img src="images/undraw_finish_line_katerina_limpitsouni_xy20.png" loading="lazy" sizes="(max-width: 991px) 100vw, (max-width: 1439px) 38vw, 484.234375px" srcset="images/undraw_finish_line_katerina_limpitsouni_xy20-p-500.png 500w, images/undraw_finish_line_katerina_limpitsouni_xy20.png 535w" alt="" class="hero-image"></div>
    </div>
  </div>
  <div>
    <div class="content w-container">
      <div class="target-hero">Utrzymuj z nami swoją <strong class="target-hero-bold">motywację sportową</strong> i jednocześnie <strong class="target-hero-bold">wspomagaj potrzebujących</strong>, a to nie wszystko!</div>
      ...
      <div class="w-layout-grid grid-target">
        <div id="w-node-b922e9023a6a-35de40d0" class="grid-one-target">
          <div class="target-block-image"><img src="images/Component-10-–-1.png" loading="lazy" alt="" class="target-image"></div>
        ...
        <div id="w-node-8997504ef119-35de40d0" class="grid-one-target">
          <div class="target-block-image"><img src="images/Component-11-–-1.png" loading="lazy" alt="" class="target-image"></div>
          <div class="target-block-text">
            <h4 class="target-heading">Pomagaj organizatorom</h4>
            <div class="target-text">Twoja opinia pozwala organizatorom udoskonalać kolejne edycje zawodów</div>
          </div>
        </div>
        <div id="w-node-e0fc3773da55-35de40d0" class="grid-one-target">
          <div class="target-block-image"><img src="images/Component-12-–-1.png" loading="lazy" alt="" class="target-image"></div>
          <div class="target-block-text">
        ...
        <div id="w-node-1f27fb092fb3-35de40d0" class="grid-one-target">
          <div class="target-block-image"><img src="images/Component-15-–-1.png" loading="lazy" alt="" class="target-image"></div>
          <div class="target-block-text">
        ...
        <div id="w-node-7701654863b3-35de40d0" class="grid-one-target">
          <div class="target-block-image"><img src="images/Component-14-–-1.png" loading="lazy" alt="" class="target-image"></div>
          <div class="target-block-text">
        ...
        <div id="w-node-9d186e5a32ef-35de40d0" class="grid-one-target">
          <div class="target-block-image"><img src="images/Component-13-–-1.png" loading="lazy" alt="" class="target-image"></div>
          <div class="target-block-text">
  ...
  <div>
    <div class="content w-container">
      ...
      <div class="w-layout-grid grid-how-working">
        <div class="how-working-div"><img src="images/ramka1.png" loading="lazy" alt="" class="how-working-image">
          <div class="how-working-block">
            <div>
              <h4 class="how-working-div-heading">Wybierz fundację</h4>
            </div>
            <div class="how-working-block-text">
              <div class="how-working-text">Wybierz jedną spośród czterech fundacji i zbieraj dla niej środki.</div>
            </div>
          </div>
        </div>
        <div class="how-working-div"><img src="images/ramka2.png" loading="lazy" alt="" class="how-working-image">
          <div class="how-working-block">
            <div>
        ...
        <div class="how-working-div"><img src="images/ramka3.png" loading="lazy" alt="" class="how-working-image">
          <div class="how-working-block">
            <div>
              <h4 class="how-working-div-heading">Wyraź opinię</h4>
            </div>
            <div class="how-working-block-text">
              <div class="how-working-text">Oceń wydarzenie, w którym brałeś udział na naszej stronie.</div>
            </div>
          </div>
        </div>
        <div class="how-working-div"><img src="images/ramka4.png" loading="lazy" alt="" class="how-working-image">
          <div class="how-working-block">
            <div>
        ...
        <div class="how-working-div"><img src="images/ramka5.png" loading="lazy" alt="" class="how-working-image">
          <div class="how-working-block">
            <div>
        ...
        <div class="how-working-div"><img src="images/ramka6.png" loading="lazy" alt="" class="how-working-image">
          <div class="how-working-block">
            <div>
              <h4 class="how-working-div-heading">Wygrywaj</h4>
            </div>
            <div class="how-working-block-text">
              <div class="how-working-text">Zbieraj punkty dzięki ocenianiu wydarzeń i walcz o wspaniałe nagrody.</div>
            </div>
          </div>
        </div>
      </div>
  ...
  <div>
    <div class="content w-container">
      ...
      <div class="w-layout-grid grid-foundation">
        <div id="w-node-e617a850cf5a-35de40d0" data-w-id="ca9809f8-de1a-068e-6ed6-e617a850cf5a" class="foundation-div"><img src="images/logo_rnr.png" loading="lazy" alt=""></div>
        <div id="w-node-af7de7e64096-35de40d0" class="foundation-div"><img src="images/fdds_1.png" loading="lazy" alt=""></div>
        <div id="w-node-9943a015031b-35de40d0" class="foundation-div"><img src="images/DOM-logo-mod2.png" loading="lazy" alt=""></div>
        <div id="w-node-95b87edfc4cd-35de40d0" class="foundation-div"><img src="images/logo.png" loading="lazy" alt=""></div>
      </div>
    ...
    <div class="content w-container">
      ...
      @foreach($events as $event)
        <a href="{{ url('wydarzenia', [$event->slug]) }}" class="featured-event-link-block w-inline-block">
          <div class="featured-events-div"><img src="{{$event->photo->file}}" loading="lazy" alt="" class="event-image"></div>
  ...
  <div>
    <div class="content w-container">
      ...
      <div class="w-layout-grid grid-partners">
        <div id="w-node-d210b884e163-35de40d0" class="partner-div"><img src="images/abf7b32_logo-fundacja.png" loading="lazy" alt=""></div>
        <div id="w-node-75dc3d9c4a73-35de40d0" class="partner-div"><img src="images/logo-38--pko-wm-1.png" loading="lazy" alt=""></div>
        <div id="w-node-0ab33c18c99d-35de40d0" class="partner-div"><img src="images/Image-2.png" loading="lazy" alt=""></div>
        <div id="w-node-6bf61f54ff91-35de40d0" class="partner-div"><img src="images/Image-1.png" loading="lazy" alt=""></div>
        <div id="w-node-74a6e87a23bb-35de40d0" class="partner-div"><img src="images/gpmlog91.png" loading="lazy" alt=""></div>
      </div>
    </div>
  </div>
  <div class="section-cta">
