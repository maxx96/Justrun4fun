            ...
            <div class="content w-container">
                <div class="menu">
                    ...
                    <a href="{{ route('login') }}" aria-current="page"
                        class="submit-button navbar-button w-button w--current">Zaloguj</a>
                </div>
            </div>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="form-login">
                        ...
                        <div class="password-div">
                            <img src="{{ asset('images/Component-21-–-1.png') }}" loading="lazy" alt=""
                                class="form-login-image">
                            <x-jet-label for="password" class="form-login-text" value="{{ __('Hasło') }}" />
                        </div>
                        <x-jet-input type="password" class="form-login-text-field w-input" maxlength="256" name="password"
                        ...
                        <a class="remind-password w-inline-block" href="{{ route('password.request') }}">
                            <div class="form-login-text no-remember-password">{{ __('Nie pamiętasz hasła?') }}</div>
                        </a>
                        @endif

                        @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="button-submit-outside w-button">
