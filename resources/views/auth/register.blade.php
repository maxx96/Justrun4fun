            ...
            <div class="content w-container">
                <div class="menu">
                    <a href="{{ route('index') }}" aria-current="page" class="menu-logo w-nav-brand w--current"><img
                            src="images/logo.svg" loading="lazy" alt="" class="menu-logo-image"></a>
                    <nav role="navigation" class="nav-menu w-nav-menu">
                        <div class="menu-logo-mobile"><img src="images/logo.svg" loading="lazy" alt=""
                            ...
                            <nav class="dropdown-list w-dropdown-list">
                                <div class="submenu">
                                    <a href="faq.html" class="submenu-block w-inline-block"><img
                                            src="images/faq-icon.svg" loading="lazy" alt="" class="submenu-icon">
                                    ...
                                    <a href="https://www.facebook.com/" target="_blank"
                                        class="submenu-block w-inline-block"><img src="images/chat-icon.svg"
