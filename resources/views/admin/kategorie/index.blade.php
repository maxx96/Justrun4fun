...
<html data-wf-page="6014041c11c3ef3ea30376e0" data-wf-site="600c61116aae5f5691a390c2">
<head>
  <meta charset="utf-8">
  <title>kategorie</title>
  <meta content="kategorie" property="og:title">
  <meta content="kategorie" property="twitter:title">
      ...
      <div class="content w-container">
        <div class="menu">
          ...
          <nav role="navigation" class="nav-menu w-nav-menu">
            ...
            <a href="../admin/kategorie.html" aria-current="page" class="nav-link w-nav-link w--current">Kategorie</a>
  ...
  <div class="section">
    <div class="content w-container">
      ...
      <div class="list-user-div">
        <div>
          <div class="w-layout-grid grid-category-header">
            <div>ID</div>
            <div>Nazwa</div>
            <div>Ilość punktów</div>
          </div>
        </div>
        @foreach($categories as $category)
        <div>
          <div class="w-layout-grid grid-category-content">
            <div class="list-event-text">{{$category->id}}</div>
            <div class="list-event-text">{{$category->name}}<br></div>
            <div class="list-event-text">{{$category->points}}<br></div>
            <a href="../admin/kategorie/{{$category->id}}/edit" class="list-user-text list-user-text-link">Zarządzaj</a>
          </div>
        </div>
        @endforeach
      </div>
