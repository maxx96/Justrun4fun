  ...
  <div class="section">
    <div class="content w-container">
      ...
      <div class="list-user-div">
        <div>
          <div class="w-layout-grid grid-user-header">
            <div>ID</div>
            <div>E-mail</div>
            <div>Rola</div>
            <div>Ranking</div>
        ...
        <div>
          <div class="w-layout-grid grid-user-content">
            <div class="list-user-text">{{$user->id}}</div>
            <div class="list-user-text">{{$user->email}}<br></div>
            <div class="list-user-text">{{$user->role->name}}</div>
            <div class="list-user-text">{{$user->is_active == 1 ? 'Aktywny' : 'Nieaktywny'}}</div>
            <div class="list-user-text">{{$user->created_at}}<br></div>
            <div class="list-user-text">{{$user->updated_at}}<br></div>
            <a href="{{ url('admin/uzytkownicy', [$user->id]) }}" class="list-user-text list-user-text-link">Link</a>
          </div>
        </div>
        @endforeach
      </div>
