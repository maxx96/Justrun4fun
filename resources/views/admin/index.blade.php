    ...
    <div class="section">
        <div class="content w-container">
            ...
            <div class="admin-panel-manage">
                ...
                <a href="{{ route('wydarzenia.index') }}" class="button-submit-outside w-button">Przejdź do listy
                    wydarzeń</a>
                <a href="{{ route('wydarzenia.create') }}" class="button-submit-outside w-button">Dodaj nowe
                    wydarzenie</a>
            </div>
            <div class="admin-panel-manage">
                <div class="target-hero">Zarządzaj kategoriami</div>
                <a href="{{ route('kategorie.index') }}" class="button-submit-outside w-button">Przejdź do listy
                    kategorii</a>
            </div>
            <div class="admin-panel-manage">
                <div class="target-hero">Zarządzaj fundacjami</div>
                <a href="{{ route('fundacje.index') }}" class="button-submit-outside w-button">Przejdź do listy
                    fundacji</a>
            </div>
