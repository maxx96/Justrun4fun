    ...
    @endif
      <div class="profil-info">
        <div class="profil-details-div">
          <div class="profil-image" style="background-image: url('{{$user->photo->file}}')">
          </div>
        ...
        <div class="profil-info-foundation">
          ...
          @elseif($collection <= 0)
          <div class="profil-info-other">Wspierasz: <strong class="profil-info-bold-text">{{$user->foundation->name}}</strong></div>
          <div class="profil-info-other">Jeszcze nic nie zebrano :(</div>
          @else
          <div class="profil-info-other">Wspierasz: <strong class="profil-info-bold-text">{{$user->foundation->name}}</strong></div>
          <div class="profil-info-other">Ilość punktów: <strong class="profil-info-bold-text">{{$user->total_points}}</strong></div>
          <div class="profil-info-other">Dzięki Tobie uzbierano już: <strong class="profil-info-bold-text">{{$collection}}</strong></div>
            @endif
        </div>
        <div>
        ...
        @if ($row->is_active==0)
          ...
          @else
            <div class="my-event">
              ...
              <div class="my-event-details">
                <a href="{{ url('wydarzenia', [$row->slug]) }}" class="button-details-event w-button">Oczekuje na opinię</a>
              </div>
            </div>
          @endif
        @else
