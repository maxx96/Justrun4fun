            ...
            <div class="login-div">
                <div class="w-form">
                    ...
                    <form method="POST" action="{{ route('change.password') }}" class="form-login">
                        ...
                        <x-jet-input type="password" class="form-login-text-field w-input" maxlength="256"
                            name="current_password" placeholder="" id="password" autocomplete="current-password" />

                        <div class="password-div">
                            <x-jet-label for="password" class="form-login-text" value="{{ __('Nowe hasło') }}" />
                        </div>
                        <x-jet-input type="password" class="form-login-text-field w-input" maxlength="256"
                            name="new_password" placeholder="" id="new_password" autocomplete="current-password" />

                        <div class="password-div">
                            <x-jet-label for="password" class="form-login-text"
                                value="{{ __('Potwierdź nowe hasło') }}" />
                        </div>
                        <x-jet-input type="password" class="form-login-text-field w-input" maxlength="256"
                            name="new_confirm_password" placeholder="" id="new_confirm_password"
